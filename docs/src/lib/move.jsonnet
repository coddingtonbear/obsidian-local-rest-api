  ...
  parameters: [
    {
      name: 'Destination',
      'in': 'header',
      description: 'The new path for the file, relative to your vault root. Path must not contain ".." or start with "/". If the path ends with a trailing slash, the source filename is preserved and the file is placed in that directory (e.g. "archive/" moves "notes/todo.md" to "archive/todo.md").\n',
      required: true,
      schema: {
        type: 'string',
        format: 'path',
