...

{
  ...
  responses: {
    '200': {
      description: 'Success; content appended to the targeted section (via URL path elements). The full updated file content is returned. Any advisory warnings (e.g. a heading rebased past level 6) are JSON-encoded, then percent-encoded, in the `MD-Patch-Warnings` response header.',
      headers: {
        'MD-Patch-Warnings': {
